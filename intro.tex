...
Mid-resolution satellite images can be used for large scale surveys to tackle distrotion as well as reduce the cost, but the identification of roads on mid-resolution~(>~5~m) satellite data is difficult and often has low accuracy. A typical two-lane road has a width of around 7~m, and this road will have a width of hardly a pixel in our satellite image. This work is an effort to use the image segmentation techniques into the area of remote sensing to detect roads in mid-resolution satellite images.
