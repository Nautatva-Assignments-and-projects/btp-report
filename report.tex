...
\tableofcontents
% TODO: Refernces show end page instead of the first
\newpage
...
\include{intro}
\include{problemBackground}
\include{previousWork}
\include{literature}
\include{proposedModel}
\include{handleTraining}
\include{resultsConculusion}
%\begin{appendices}
% TODO: Appendix make the tex file and go about it as usual.
%\include{nameofappendix}
%\end{appendices}
\normalem
