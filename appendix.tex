...
The easiest way to install GDAL is by using anaconda. Install anaconda from \href{https://www.anaconda.com/products/individual#Downloads} and run \mint{bash}{conda install -y gdal} on command line(CMD) or terminal.
